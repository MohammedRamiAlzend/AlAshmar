...
public record CreateDawraDto(string EventName, Guid SemesterId);
public record UpdateDawraDto(string EventName);

public record CreateHalaqaDto(string ClassName, Guid DawraId);
